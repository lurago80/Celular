...
class ProdutoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'fornecedor', 'ativo', 'imei', 'imei2',
        ]
        widgets = {
            'nome': forms.TextInput(attrs=_bs()),
            'tipo': forms.Select(attrs=_bs({'id': 'id_tipo'})),
            ...
            'imei': forms.TextInput(attrs=_bs({'placeholder': '15 dígitos', 'maxlength': '15', 'data-imei': '1'})),
            'imei2': forms.TextInput(attrs=_bs({'placeholder': '15 dígitos (opcional — dual SIM)', 'maxlength': '15', 'data-imei': '2'})),
        }
        labels = {
...
class SerialForm(forms.ModelForm):
    ...
    class Meta:
        model = SerialProduto
        fields = ['serial', 'imei', 'imei2', 'status', 'observacoes']
        widgets = {
            ...
            'imei2': forms.TextInput(attrs=_bs({'placeholder': '15 dígitos (dual SIM - opcional)', 'maxlength': '15'})),
            'status': forms.Select(attrs=_bs()),
            'observacoes': forms.TextInput(attrs=_bs({'placeholder': 'Observações opcionais'})),
        }
        labels = {
            'serial': 'Número de Série *',
            'imei': 'IMEI 1 (opcional)',
